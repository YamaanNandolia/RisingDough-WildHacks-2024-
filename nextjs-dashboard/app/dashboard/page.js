  ...
  return (
    <main className='grid grid-cols-1 md:grid-cols-2 gap-6'>
      <div className="md:col-span-1 gap-6 flex flex-col">
        <div className="flex gap-6 rounded-lg bg-gray-50 px-10 py-5 md:px-20" >
          <Doughnut />
        </div>
        <div className="flex gap-6 rounded-lg bg-gray-50 px-10 py-5 md:px-20" >
      ...
      <div className="flex flex-col items-center justify-center rounded-lg bg-gray-50 px-10 py-10 md:w-4/5 md:px-20">
