...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex h-30 shrink-0 items-end rounded-lg bg-iceblue p-4 md:h-40">
        <AcmeLogo />
      </div>
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <p className={`${inter.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
          ...
          <Link
            href="/login"
            className="flex items-center gap-5 self-start rounded-lg bg-orange px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
